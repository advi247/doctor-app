  ...
  return (
    <View style={styles.profileContainer}>
      ...
      <View style={styles.header}>
        <Text style={styles.doctorName}>Dr. {dname}</Text>
      </View>
      ...
      <View style={styles.buttonContainer}>
        ...
        onPress={() => navigation.navigate('EditDocProfile')}>
        ...
        onPress={() => navigation.navigate('View Appointments')}>
          <View style={styles.buttons}>
            <View style={styles.icon}>
              <Octicons
                name={'checklist'}
      ...
      <View style={styles.aboutSection}>
        <Text style={styles.aboutTitle}>About Dr. {dname}</Text>
